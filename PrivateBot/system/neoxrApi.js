...
module.exports = class NeoxrApi {
  ...
  tiktok = async (url) => {
    let json = await Func.fetchJson(
      "https://sh.xznsenpai.xyz/api/tiktok?url=" + url
    );
    return json;
  };
  ...
  nobg = async (image) => {
    let tes = await Func.fetchJson(
      "https://sh.xznsenpai.xyz/api/removebg?url=" + image
    );
    if (tes.status) {
      return "https://telegra.ph/file/bd7c397ed84a4819834f6.jpg";
    } else {
      let json = "https://sh.xznsenpai.xyz/api/removebg?url=" + image;
      return json;
    }
  };
  ...
  ai = async (text) => {
    let json = await Func.fetchJson(
      "https://sh.xznsenpai.xyz/api/openai?text=" + text
    );
    return json;
  };
  ...
  ttsearch = async (query) => {
    const json = await Func.fetchJson(
      "https://sh.xznsenpai.xyz/api/ttsearch?count=3&search=" + query
    );
    return json;
  };
  aiscene = async (url) => {
    const tes = await Func.fetchJson(
      "https://sh.xznsenpai.xyz/api/aiscene?url=" + url
    );
    if (tes.status) {
      return "https://telegra.ph/file/bd7c397ed84a4819834f6.jpg";
    } else {
      const json = "https://sh.xznsenpai.xyz/api/aiscene?url=" + url;
      return json;
    }
  };
};
